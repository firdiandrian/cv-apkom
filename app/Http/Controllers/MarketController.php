...
class MarketController extends Controller
{
    public function index()
    {
        ...
        return view('markets.index', $responseData);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['status' => true, 'message' => 'Barang has been updated']);
    }
    ...
    public function destroy($ID)
    {
        ...
        return response()->json(['status' => true, 'message' => 'Barang has been deleted']);
    }
